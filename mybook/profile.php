        ...
        <div style="background-color: white; text-align:center; color:#405d9b;">
            ...
            <div style="font-size: 30px;">
                ...
                <a href="like.php?type=user&id=<?php echo $user_data['userid'] ?>">
                    <input id="post_button" type="button" value="Follow <?php echo $mylikes ?>" style="margin: right 10px; background-color:#9b409a; width:auto;"></a>
            ...
            if ($user_data['userid'] == $_SESSION['mybook_userid']) {
                echo '<a href="profile.php?section=settings&id=' . $user_data['userid'] . ' ">
                    <div id="menu_buttons">Setting</div></a>';
            }
            ?>
        </div>
        <!--below cover area-->
